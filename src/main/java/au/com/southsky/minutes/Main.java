...
public class Main {
  ...
  public static void main(String[] args) throws IOException {
    ...
    StringBuilder builder =
        new StringBuilder(style)
            .append("<h1>")
            .append(
                (o.reportHeading == null)
                    ? o.repositoryName + " meeting " + o.getLabelsString()
                    : o.reportHeading)
            .append("</h1>")
            ...
            .append(
                (!o.getLabelsString().isEmpty())
                    ? "<br>Selected issues labelled with " + o.getLabelsString()
                    : "<br>All issues")
            .append((o.includeClosed) ? " (including closed issues)" : "");

    if (o.fromDate.after(new Date())) {
      builder.append("<br>Comments are suppressed");
    } else {
      builder
